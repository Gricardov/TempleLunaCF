        ...
        case 'FEEDBACK_GIVEN':
            {
                ...
                htmlText = mailTemplate.toString()
                    .replace(/{{title}}/g, subject)
                    .replace(/{{bodyText}}/g, `¡Hola, ${receiverName}!<br/>Tu trabajo en la obra "${title}" ha recibido un comentario ¡Felicitaciones!. Leelo en tu cuenta o desde este botón:`)
                    .replace(/{{linkto}}/g, linkTo);
            }
            break;
        ...
        case 'LIKE_GIVEN':
            {
                ...
                htmlText = mailTemplate.toString()
                    .replace(/{{title}}/g, subject)
                    .replace(/{{bodyText}}/g, `¡Hola, ${receiverName}!<br/>Tu trabajo en la obra "${title}" ha recibido un corazón ¡Felicitaciones!. Leelo desde tu cuenta aquí:`)
                    .replace(/{{linkto}}/g, linkTo);
            }
            break;
    }
